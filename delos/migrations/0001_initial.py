# Generated by Django 2.2.8 on 2020-01-28 12:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(choices=[('1', '월요일'), ('2', '화요일'), ('3', '수요일'), ('4', '목요일'), ('5', '금요일'), ('6', '토요일'), ('7', '일요일')]), size=None)),
